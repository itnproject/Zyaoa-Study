...
export default class Notification {
    ...
    render() {
        ...
        return `
            <div class="ctn-notification ctn-notification-${this.type}" id="notification-${Date.now()}">
                <div class="ctn-notification-icon">
                    ${icons[this.type]}
                </div>
                <div class="ctn-notification-content">
                    ${this.title ? `<div class="ctn-notification-title">${this.title}</div>` : ''}
                    <div class="ctn-notification-message">${this.message}</div>
                </div>
                ${this.closable ? `
                    <button class="ctn-notification-close" onclick="this.closest('.ctn-notification').remove()">
